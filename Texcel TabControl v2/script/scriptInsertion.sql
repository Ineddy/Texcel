...
('CivilWar',	'GamaPlay',	'Parcourir pluieurs villes dans le but de conquerir des térritoires','Windows XP, 2Go Ram, processeur dual core',	1,null),
('NHL08',	'EASport',	'Jouez des matchs de hockey avec vos amis',	'Windows XP, 2Go Ram, processeur dual core',2,null),
('NHL09',	'EASport',	'Jouez des matchs de hockey avec vos amis',	'Windows XP, 2Go Ram, processeur dual core',3,null),
('Battle Field',	'MacroIndustrie',	'Vous etes un millitaire. Servez votre patrie.',	'Windows XP, 2Go Ram, processeur dual core',4,null),
('ForHonor',	'Ubisoft',	'Combat à l''épée au 19 siecle.',	'Windows XP, 2Go Ram, processeur dual core',5,null),
('Fifa17',	'EASport',	'Jouez au soccer avec vos amis.',	'Windows XP, 2Go Ram, processeur dual core',6,null),
('Hitman',	'BluePlay',	'Vous etes un espion. Remplissez des missions secretes.',	'Windows XP, 2Go Ram, processeur dual core',7,null);
